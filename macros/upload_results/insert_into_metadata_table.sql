{% macro insert_into_metadata_table(dataset, fields, content) -%}
    ...
    {% if content != "" %}
        ...
        {% set dataset_relation = dbt_artifacts_versionless.get_relation(dataset) %}
        {# Insert the data into the table #}
        {{ return(adapter.dispatch('insert_into_metadata_table', 'dbt_artifacts_versionless')(dataset_relation, fields, content)) }}
